            ...
            <thead>
              <tr style={{ background: "var(--table-header-bg)" }}>
                ...
                <th style={{ ...headerCell, textAlign: "right" }}>
                  <button type="button" className="table-sort table-sort--right" onClick={() => toggleSort("salary")}>
                    Salary
                    {sortIndicator(sortKey === "salary", sortDir)}
                  </button>
                </th>
                <th style={{ ...headerCell, textAlign: "right" }}>
                  <button type="button" className="table-sort table-sort--right" onClick={() => toggleSort("target")}>
                    Target
                    {sortIndicator(sortKey === "target", sortDir)}
                  </button>
                </th>
                <th style={{ ...headerCell, textAlign: "center" }}>
                  <button type="button" className="table-sort table-sort--center" onClick={() => toggleSort("status")}>
                    Status
                    {sortIndicator(sortKey === "status", sortDir)}
                  </button>
                </th>
                <th style={{ ...headerCell, textAlign: "right" }}>
                  <button type="button" className="table-sort table-sort--right" onClick={() => toggleSort("joined")}>
                    Joined
          ...
          <div className="drawer-panel drawer-panel--md" onClick={(e) => e.stopPropagation()}>
            ...
            {!editMode ? (
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  <label className="text-xs font-semibold text-[var(--text-muted)]">Monthly target</label>
                  <input
                    className="input"
            ...
            <div className="flex justify-end gap-2">
              {!editMode ? (
                <button className="btn" onClick={() => setEditMode(true)} disabled={!canEditSelected}>
                  Edit
                </button>
              ) : (
                <>
                  ...
                  <button className="btn" onClick={saveEmployee} disabled={saving || !canEditSelected}>
                    {saving ? "Saving..." : "Save"}
                  </button>
                </>
              )}
