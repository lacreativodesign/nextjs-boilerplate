...
/**
 * S32: a segment-level error boundary for the HR dashboard.
 *
...
export default function HrError({
  ...
  useEffect(() => {
    console.error('HR section error:', error);
  }, [error]);

  return <ErrorFallback error={error} resetError={reset} context="module" moduleName="HR" />;
}
