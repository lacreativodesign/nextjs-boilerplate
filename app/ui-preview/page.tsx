    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          >
            <span style={{ fontWeight: 600, color: '#111827' }}>BIZOSTO ERP</span>
          ...
          >
            {['Revenue', 'Utilization', 'Active Projects'].map((label) => (
              ...
              >
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: '#111827' }}>$128k</span>
                <div
                  style={{
                    height: 4,
                    borderRadius: 999,
  ...
  if (variant === 'futuristic') {
    return (
      <div
        style={{
          ...base,
          background: 'radial-gradient(circle at top, #22d3ee30, #020617 65%, #000000)',
          border: '1px solid rgba(56,189,248,0.5)',
          boxShadow: '0 0 40px rgba(56,189,248,0.45), 0 0 0 1px rgba(15,23,42,0.9)',
        }}
      >
        {/* Sidebar */}
        <div
          ...
          {['☰', '📊', '👥', '⚙️'].map((icon, idx) => (
            <div
              ...
              style={{
                ...
                borderRadius: 999,
                background:
                  idx === 1 ? 'linear-gradient(90deg,#22d3ee,#a855f7)' : 'rgba(15,23,42,0.8)',
                color: '#E5E7EB',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 13,
                boxShadow: idx === 1 ? '0 0 15px rgba(56,189,248,0.7)' : 'none',
              }}
            >
              {icon}
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div
            style={{
              height: 32,
              background: 'linear-gradient(90deg,rgba(15,23,42,0.65),rgba(15,23,42,0.95))',
          ...
          >
            <div
              style={{
                borderRadius: 10,
                background: 'radial-gradient(circle at top left,#22d3ee33,#0f172a)',
                ...
                {[30, 60, 45, 72, 50, 80].map((h, i) => (
                  <div
                    ...
                    style={{
                      ...
                      height: `${h}%`,
                      boxShadow: i === 5 ? '0 0 10px rgba(56,189,248,0.8)' : 'none',
                    }}
                  />
                ))}
              </div>
            ...
            >
              <div style={{ fontSize: 10, color: '#9CA3AF' }}>Quick Stats · Last 24h</div>
              {[
                ['New Leads', '+34'],
                ['Projects Active', '18'],
                ['On-time Delivery', '96%'],
  ...
  if (variant === 'agency') {
    return (
      <div
        style={{
          ...base,
          background: 'linear-gradient(135deg,#eef2ff 0%,#e0f2fe 45%,#fdf2ff 100%)',
      ...
      >
        ...
        <div
          style={{
            background: 'linear-gradient(180deg,#1f2937,#111827 50%,#0f172a 100%)',
            padding: 10,
            display: 'flex',
            flexDirection: 'column',
            gap: 10,
          ...
          {['Overview', 'Clients', 'Projects', 'Billing'].map((label, idx) => (
            <div
              ...
              style={{
                ...
                padding: '6px 8px',
                borderRadius: 999,
                background: idx === 0 ? 'linear-gradient(90deg,#6366F1,#22C55E)' : 'transparent',
        ...
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
            background: 'radial-gradient(circle at top,#e0e7ff 0,#f9fafb 40%,#ffffff 100%)',
          }}
        >
          <div
            style={{
              ...
              >
                <div
                  style={{
                    ...
                    height: 30,
                    borderRadius: '50%',
                    background: 'conic-gradient(#22C55E 0 270deg,#E5E7EB 270deg 360deg)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    fontSize: 10,
...
export default function UiPreviewPage() {
  return (
    ...
    >
      ...
      >
        These are small visual mocks of how your ERP could look with different global themes.
        We&apos;ll lock one style and then apply it everywhere: login, all dashboards, tables,
        modals, and more.
      </p>
