...
export default function AMFilesPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return files.filter((file) => {
      ...
      if (q) {
        const hay = [file.fileName, file.projectName, file.clientName]
          .filter(Boolean)
          .join(' ')
          .toLowerCase();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="page-subtitle">
          Upload and track the latest drafts, revisions, and finals for your projects.
        </p>
      </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <MasterSelect
            ...
            options={[
              ...
              ...FILE_CATEGORIES.map((value) => ({ value, label: value })),
            ]}
          />
          <MasterSelect
            value={projectFilter}
