...
export default function ClientProjectsPage() {
  ...
  const filtered = useMemo(
    () =>
      smartMatch(projects, search, (project) => [
        project.projectName,
        project.projectType,
        project.stage,
      ]),
              ...
              <>
                ...
                <Section title="Project Summary">
                  ...
                  <Row
                    ...
                    value={
                      selected.project.clientApprovalStatus === 'approved' ? 'Approved' : 'Pending'
                    }
                  />
                </Section>
                      ...
                      <div className="mt-4 grid gap-3">
                        ...
                        <div className="flex justify-end">
                          <button
                            ...
                            disabled={actionLoading || !crTitle || !crDescription}
                          >
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="card" style={{ padding: 14, borderRadius: 14 }}>
      <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.06em', opacity: 0.75 }}>
        {title}
      </div>
