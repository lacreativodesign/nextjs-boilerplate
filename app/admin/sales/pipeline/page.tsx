...
export default function SalesPipelinePage() {
  ...
  const pipelineDeals = useMemo(
    () => deals.map((deal) => ({ ...deal, valueUsd: deal.valueUsd || 0 })),
    [deals],
  );
  ...
  return (
    <div className="w-full">
          ...
          <div className="card" style={{ padding: 16, borderRadius: 14 }}>
            ...
            <div style={{ display: 'grid', gap: 8, fontSize: 14 }}>
              ...
              <SummaryRow
                ...
                value={formatDate(selectedDeal.expectedCloseDate)}
              />
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              <label style={{ display: 'grid', gap: 6 }}>
                ...
                <MasterSelect
                  ...
                  onChange={(value) =>
                    setSelectedDeal((prev) => (prev ? { ...prev, stage: value } : prev))
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSelectedDeal((prev) =>
                      prev ? { ...prev, valueUsd: Number(e.target.value) } : prev,
                    )
                  }
                />
              </label>
              <label style={{ display: 'grid', gap: 6 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSelectedDeal((prev) =>
                      prev ? { ...prev, probability: Number(e.target.value) } : prev,
                    )
                  }
                />
              </label>
      ...
      {actionLoading &&
        ...
        actionLoading !== 'Closed Won' &&
        actionLoading !== 'Closed Lost' && (
