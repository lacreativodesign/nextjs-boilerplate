    ...
    <div>
        ...
        <div className="grid gap-3 md:grid-cols-4">
          <label style={{ fontSize: 13 }}>
            ...
            <select
              className="input"
              value={reportType}
              onChange={(event) => setReportType(event.target.value as "profit-loss" | "balance-sheet" | "cash-flow")}
            >
          ...
          <div style={{ display: "flex", alignItems: "end" }}>
            <button className="btn" onClick={generateReport} disabled={loading} style={{ borderRadius: 10, width: "100%" }}>
        ...
        {profitLossReport ? (
          <>
            <div style={{ marginTop: 14, display: "flex", gap: 10, flexWrap: "wrap" }}>
              <button className="btn" onClick={exportToPDF} style={{ borderRadius: 10, display: "inline-flex", gap: 6 }}>
                <FileText size={16} /> Export PDF
              </button>
              <button className="btn" onClick={exportToExcel} style={{ borderRadius: 10, display: "inline-flex", gap: 6 }}>
            ...
            <div className="grid gap-4 md:grid-cols-2" style={{ marginTop: 16 }}>
              <div className="card" style={{ padding: 16, borderRadius: 16 }}>
                ...
                <div style={{ marginTop: 14 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontWeight: 700 }}>
                    <span>Revenue</span>
                    <span style={{ color: "#16a34a" }}>{formatCurrency(profitLossReport.revenue.total)}</span>
                  </div>
                </div>
                ...
                <div style={{ marginTop: 14, borderTop: "1px solid var(--line)", paddingTop: 12 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontWeight: 700 }}>
                    <span>Expenses</span>
                    <span style={{ color: "#dc2626" }}>{formatCurrency(profitLossReport.expenses.total)}</span>
                  </div>
                ...
                <div style={{ marginTop: 14, borderTop: "1px solid var(--line)", paddingTop: 12 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", fontWeight: 800, fontSize: 18 }}>
                    ...
                    <span style={{ color: profitLossReport.netIncome >= 0 ? "#16a34a" : "#dc2626" }}>
              ...
              <div className="card" style={{ padding: 16, borderRadius: 16 }}>
                <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 10 }}>Expense Breakdown</div>
      ...
      >
        ...
        <ul style={{ fontSize: 13, opacity: 0.75, paddingLeft: 18, listStyle: "disc" }}>
          <li>Profit &amp; Loss report uses paid invoices and categorized expenses in the selected period.</li>
          <li>PDF export provides board-ready formatting for executive and investor distribution.</li>
