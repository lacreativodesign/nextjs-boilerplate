        ...
        <div className="drawer-overlay" onClick={closeDrawer}>
          <div className="drawer-panel drawer-panel--md" onClick={(e) => e.stopPropagation()}>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormState({ ...formState, expectedCloseDate: e.target.value })
                    }
                  />
                </div>
                <div>
            ...
            <Section title="Discount Approval">
              <InfoRow
                label="List Price"
                value={formatUsd(selected.listPriceUsd || selected.valueUsd)}
              />
              <InfoRow label="Discount %" value={`${Number(selected.discountPct || 0)}%`} />
              <InfoRow
                label="Final Price"
                value={formatUsd(selected.finalPriceUsd || selected.valueUsd)}
              />
              ...
              <InfoRow label="Requested At" value={formatDate(selected.discountRequestedAt)} />
              <InfoRow
                label="Approved By"
            ...
            <Section title="Linked Delivery">
              {selected.stage === 'Closed Won' || selected.clientId || selected.projectId ? (
                ...
                <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>
                  Linked records appear once a deal is won.
                </div>
              )}
            </Section>
