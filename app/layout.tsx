      ...
      <body className={dmSans.className}>
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('bizosto_theme')||'system';var d=window.matchMedia('(prefers-color-scheme:dark)').matches;var dark=t==='dark'||(t==='system'&&d);document.documentElement.classList.toggle('dark',dark);document.documentElement.classList.toggle('light',!dark&&t==='light');var density=localStorage.getItem('bizosto_workspace_density_v1')==='compact'?'compact':'comfortable';document.documentElement.dataset.density=density;}catch(e){}})();`,
          }}
        />
        <ThemeProvider>
          <DensityProvider>
