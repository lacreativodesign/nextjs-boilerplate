            ...
            <thead>
              <tr>
                ...
                <th style={{ textAlign: 'left', padding: '14px 16px', fontWeight: 700 }}>
                  <button
                    type="button"
                    onClick={() => toggleSort('baseSalaryPkr')}
                    className="table-sort"
                  >
                    Base Salary (PKR){' '}
                    {sortKey === 'baseSalaryPkr' ? (sortDir === 'asc' ? '▲' : '▼') : ''}
                  </button>
                </th>
                <th style={{ textAlign: 'left', padding: '14px 16px', fontWeight: 700 }}>
                  ...
                  <td colSpan={8} style={{ padding: 0, border: 'none' }}>
                    <div className="p-6">
                      <EmptyState
                        ...
                        description="Run payroll to generate salary records for your team."
                      />
                    </div>
                  </td>
                </tr>
                  ...
                  return (
                    <tr key={row.id}>
                      ...
                      <td style={{ padding: '14px 16px', textAlign: 'center' }}>
                        {formatPkr(row.baseSalaryPkr)}
                      </td>
                      <td style={{ padding: '14px 16px', textAlign: 'center' }}>
                        {formatPkr(getTotal(row))}
                      </td>
                      <td style={{ padding: '14px 16px', textAlign: 'center' }}>
