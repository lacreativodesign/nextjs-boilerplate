...
import { Activity, BadgeCheck, LayoutDashboard, ListChecks, Menu } from "lucide-react";
...
export default function ProductionLayout({ children }: { children: React.ReactNode }) {
  ...
  const userName = tenantContext?.user?.displayName || tenantContext?.user?.email || "Production User";
