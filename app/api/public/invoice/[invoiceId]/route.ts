  ...
  try {
    ...
    return NextResponse.json({
      ...
      invoice: {
        ...
        balanceDue: validation.payload.balanceDue,
        payableNow: validation.payload.payableNow,
        paymentPlan: validation.payload.paymentPlan,
        installmentSequence: validation.payload.installmentSequence,
        firstInstallmentAmount: validation.payload.firstInstallmentAmount,
        secondInstallmentAmount: validation.payload.secondInstallmentAmount,
        balanceTriggerType: validation.payload.balanceTriggerType,
        balanceDueDate: validation.payload.balanceDueDate,
        balanceMilestoneStage: validation.payload.balanceMilestoneStage,
