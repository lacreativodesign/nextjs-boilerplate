  ...
  try {
    ...
    return NextResponse.json({
      ...
      connection: {
        ...
        channelMappings: integration?.channelMappings || { invoicePaid: null, projectMilestone: null },
...
export async function PUT(request: Request) {
  try {
    ...
    await adminDb
      ...
      .set(
        {
          defaultChannelId: body.defaultChannelId === undefined ? undefined : body.defaultChannelId || null,
          channelMappings: {
            invoicePaid: channelMappings.invoicePaid === undefined ? undefined : channelMappings.invoicePaid || null,
            projectMilestone:
              channelMappings.projectMilestone === undefined ? undefined : channelMappings.projectMilestone || null,
          },
          notifyTaskAssignedDm: body.notifyTaskAssignedDm === undefined ? undefined : Boolean(body.notifyTaskAssignedDm),
          notifyLeaveApprovedDm: body.notifyLeaveApprovedDm === undefined ? undefined : Boolean(body.notifyLeaveApprovedDm),
          commandEnabled: body.commandEnabled === undefined ? undefined : Boolean(body.commandEnabled),
          notificationEnabled: body.notificationEnabled === undefined ? undefined : Boolean(body.notificationEnabled),
