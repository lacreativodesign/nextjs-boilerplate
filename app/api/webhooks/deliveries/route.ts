...
import { listWebhookDeliveries, processPendingWebhookDeliveries } from "@/lib/webhooks/webhook-delivery";
...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json({ ok: false, error: "Unable to load webhook deliveries." }, { status: 500 });
  }
}
