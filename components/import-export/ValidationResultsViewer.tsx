  ...
  return (
    <div className="rounded border p-4">
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className={`rounded px-2 py-1 text-xs ${errorCount ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}>
      ...
      <div className="max-h-64 overflow-auto text-xs">
        {errors.map((error, index) => (
          <div key={`${error.row}-${error.field}-${index}`} className="mb-1 rounded bg-neutral-100 px-2 py-1 dark:bg-neutral-800">
