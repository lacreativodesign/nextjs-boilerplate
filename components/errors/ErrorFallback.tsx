...
export function ErrorFallback({
  ...
  const handleReportIssue = () => {
    ...
    window.open(
      `mailto:support@bizosto.com?subject=${subject}&body=${body}`,
      '_blank',
      'noopener,noreferrer',
    );
  };
  ...
  return (
    <div className="flex min-h-[400px] items-center justify-center p-6">
      <div className="max-w-lg rounded-lg border border-red-200 bg-red-50 p-8 dark:border-red-800 dark:bg-red-950">
        ...
        <h2 className="mb-2 text-center text-2xl font-bold text-red-900 dark:text-red-100">
          {getTitle()}
        </h2>
        ...
        <p className="mb-4 text-center text-sm text-red-700 dark:text-red-300">
          Suggested action: {userMessage.action}
        </p>
