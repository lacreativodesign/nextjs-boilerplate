...
const DEMO_USERS = [
  ...
  {
    email: 'demo_sales_manager@bizosto.com',
    role: 'sales_manager',
    name: 'Sarah Manager',
    uid: '',
  },
...
export async function seedDemoTenant({ tenantId }: { tenantId: string }) {
  ...
  const leadData = [
    ...
    {
      name: 'Aria Patel',
      company: 'Crestline Creative',
      email: 'aria@crestline.co',
      stage: 'Negotiation',
      source: 'Website',
      value: 31000,
      daysOld: 45,
  ...
  const projectData = [
    ...
    {
      name: 'Bloom Beauty E-commerce Redesign',
      client: clients[1],
      stage: 'Active',
      health: 'at_risk',
      budget: 18500,
    ...
    {
      name: 'Summit Partners Marketing Strategy',
      client: clients[2],
      stage: 'In Review',
      health: 'on_track',
      budget: 12000,
    ...
    {
      name: 'Nova Media Social Campaign',
      client: clients[4],
      stage: 'Active',
      health: 'on_track',
      budget: 5200,
  ...
  const notifData = [
    {
      ...
      body: 'INV-0003 from Summit Partners is 18 days overdue.',
      type: 'invoice',
    },
    {
      userId: adminUser.uid,
      title: 'Invoice overdue',
      body: 'INV-0004 from ClearPath Logistics is 9 days overdue.',
      type: 'invoice',
    },
    {
      userId: adminUser.uid,
      title: 'Project at risk',
      body: 'Bloom Beauty E-commerce Redesign is marked at risk.',
      type: 'project',
    },
    {
      userId: salesUser.uid,
      title: 'New lead assigned',
      body: 'Jordan Bell from Apex Digital has been assigned to you.',
      type: 'lead',
    },
    {
      userId: financeUser.uid,
      title: 'Payroll due',
      body: 'Monthly payroll run is due in 3 days.',
      type: 'hr',
    },
  ];
