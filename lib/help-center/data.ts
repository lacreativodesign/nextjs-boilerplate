...
export const helpCategories: HelpCategory[] = [
  {
    ...
    articles: [
          ...
          },
          {
            ...
            blocks: [
              ...
              },
              {
                ...
                caption: "Invoice builder with highlighted client selector, line item table, and send action.",
              },
            ],
          },
          {
      ...
      },
      {
        ...
        excerpt: "Add users securely, assign least-privilege roles, and enforce onboarding controls.",
        ...
        sections: [
          {
            ...
            blocks: [
              ...
              },
              {
                type: "callout",
                tone: "warning",
                content: "Use company email domains only. External addresses can be blocked by tenant policy.",
              },
            ],
          },
        ],
  ...
  },
  {
    ...
    articles: [
        ...
        sections: [
          {
            ...
            blocks: [
              ...
              },
              {
                ...
                caption: "Template editor with placeholders for terms, tax IDs, and payment blocks.",
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        relatedSlugs: ["creating-invoices"],
        sections: [{ heading: "Tax Rules", blocks: [{ type: "paragraph", content: "Configure tax rules by region and product type for accurate invoice totals." }] }],
      },
      {
        ...
        sections: [{ heading: "Key Reports", blocks: [{ type: "list", items: ["A/R Aging", "Cash Collected", "Tax Liability"] }] }],
      },
    ],
  },
  {
    ...
    icon: UserGroupIcon,
    articles: [
      { slug: "time-tracking-setup", title: "Time Tracking Setup", excerpt: "Configure timesheets and approval policies.", lastUpdated: "2026-01-09", readTime: "4 min", keywords: ["time", "timesheets"], relatedSlugs: [], sections: [{ heading: "Setup", blocks: [{ type: "paragraph", content: "Define work schedules and submit/approval windows." }] }] },
      { slug: "leave-management", title: "Leave Management", excerpt: "Create leave policies and automate balances.", lastUpdated: "2026-01-05", readTime: "4 min", keywords: ["leave", "pto"], relatedSlugs: [], sections: [{ heading: "Policies", blocks: [{ type: "paragraph", content: "Publish leave policy rules and accrual cadence." }] }] },
      { slug: "employee-onboarding", title: "Employee Onboarding", excerpt: "Standardize onboarding tasks and document collection.", lastUpdated: "2026-01-07", readTime: "3 min", keywords: ["onboarding", "hr"], relatedSlugs: [], sections: [{ heading: "Workflow", blocks: [{ type: "steps", items: ["Create onboarding checklist", "Assign manager", "Track completion"] }] }] },
      { slug: "performance-reviews", title: "Performance Reviews", excerpt: "Run review cycles with calibration workflows.", lastUpdated: "2026-01-03", readTime: "5 min", keywords: ["performance", "reviews"], relatedSlugs: [], sections: [{ heading: "Cycle Setup", blocks: [{ type: "paragraph", content: "Set frequency, reviewers, and scoring rubric." }] }] },
    ],
  },
  {
    id: "crm",
    ...
    articles: [
      { slug: "managing-leads", title: "Managing Leads", excerpt: "Capture and qualify leads with SLA tracking.", lastUpdated: "2026-01-04", readTime: "4 min", keywords: ["leads", "crm"], relatedSlugs: [], sections: [{ heading: "Lead Flow", blocks: [{ type: "steps", items: ["Import leads", "Assign owner", "Set lead score"] }] }] },
      { slug: "deal-pipeline", title: "Deal Pipeline", excerpt: "Customize stage gates and forecast confidence.", lastUpdated: "2026-01-02", readTime: "4 min", keywords: ["deals", "pipeline"], relatedSlugs: [], sections: [{ heading: "Stages", blocks: [{ type: "paragraph", content: "Define stage entry and exit criteria for reporting consistency." }] }] },
      { slug: "email-templates", title: "Email Templates", excerpt: "Standardize outreach templates with personalization fields.", lastUpdated: "2026-01-01", readTime: "3 min", keywords: ["email", "templates"], relatedSlugs: [], sections: [{ heading: "Template Library", blocks: [{ type: "paragraph", content: "Create approved templates per campaign type and segment." }] }] },
      { slug: "sales-reports", title: "Sales Reports", excerpt: "Measure conversion, velocity, and win-rate trends.", lastUpdated: "2025-12-29", readTime: "4 min", keywords: ["reports", "sales"], relatedSlugs: [], sections: [{ heading: "KPIs", blocks: [{ type: "list", items: ["Conversion rate", "Sales cycle length", "Average deal size"] }] }] },
    ],
  },
  {
    id: "integrations",
    ...
    articles: [
      ...
      { slug: "slack-notifications", title: "Slack Notifications", excerpt: "Route ERP events into operational channels.", lastUpdated: "2026-01-12", readTime: "3 min", keywords: ["slack", "notifications"], relatedSlugs: [], sections: [{ heading: "Webhooks", blocks: [{ type: "paragraph", content: "Create incoming webhook and configure event subscriptions." }] }] },
      { slug: "zapier-automation", title: "Zapier Automation", excerpt: "Trigger no-code workflows from ERP activity.", lastUpdated: "2026-01-08", readTime: "4 min", keywords: ["zapier", "automation"], relatedSlugs: [], sections: [{ heading: "Trigger Setup", blocks: [{ type: "paragraph", content: "Use signed webhooks for trusted automation callbacks." }] }] },
    ],
  },
  {
    id: "admin",
    ...
    icon: Cog6ToothIcon,
    articles: [
      { slug: "user-management", title: "User Management", excerpt: "Manage users, roles, and lifecycle actions.", lastUpdated: "2026-01-07", readTime: "5 min", keywords: ["users", "admin"], relatedSlugs: ["inviting-team-members"], sections: [{ heading: "Actions", blocks: [{ type: "list", items: ["Invite", "Suspend", "Reset MFA", "Deactivate"] }] }] },
      { slug: "billing-subscriptions", title: "Billing & Subscriptions", excerpt: "Update plans, seats, and invoices.", lastUpdated: "2026-01-06", readTime: "4 min", keywords: ["billing", "subscription"], relatedSlugs: [], sections: [{ heading: "Plan Changes", blocks: [{ type: "paragraph", content: "Plan changes prorate automatically and apply at checkout." }] }] },
      { slug: "security-settings", title: "Security Settings", excerpt: "Configure SSO, MFA, and session policies.", lastUpdated: "2026-01-14", readTime: "6 min", keywords: ["security", "mfa", "sso"], relatedSlugs: [], sections: [{ heading: "Baseline", blocks: [{ type: "list", items: ["Require MFA", "Set session timeout", "Enable audit logs"] }] }] },
      { slug: "white-label-branding", title: "White-label Branding", excerpt: "Apply tenant-specific logos, domain, and color palette.", lastUpdated: "2026-01-10", readTime: "4 min", keywords: ["branding", "white-label"], relatedSlugs: [], sections: [{ heading: "Brand Assets", blocks: [{ type: "paragraph", content: "Upload SVG logo and set verified custom domain for tenant portal." }] }] },
    ],
  },
];
...
export function searchArticles(query: string, categoryFilter?: string) {
  ...
  if (!normalized) {
    const base = categoryFilter ? allArticles.filter((item) => item.categoryId === categoryFilter) : allArticles;
