...
export const sidebarNavigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { id: "admin-dashboard", label: "Dashboard", labelKey: "navigation.dashboard", href: "/admin/dashboard", icon: "LayoutDashboard", roles: ["admin", "super_admin"] },
      { id: "admin-users", label: "Users", labelKey: "navigation.users", href: "/admin/users", icon: "Users", roles: ["admin", "super_admin"] },
      { id: "admin-clients", label: "Clients", labelKey: "navigation.clients", href: "/admin/clients", icon: "Briefcase", roles: ["admin", "super_admin"] },
      { id: "admin-automation", label: "Automation", labelKey: "navigation.automation", href: "/admin/automation", icon: "Settings", roles: ["admin", "super_admin"] },
    ],
  },
  {
    id: "sales",
