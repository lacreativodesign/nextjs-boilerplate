...
test.describe('CSRF enforcement', () => {
  test('POST /api/admin/clients/list without X-Requested-With returns 403', async ({ request }) => {
  ...
  test('POST /api/admin/users/delete without X-Requested-With returns 403', async ({ request }) => {
  ...
  test('POST /api/signup is EXEMPT from CSRF (no 403 for missing header)', async ({ request }) => {
