...
| ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------- | --------- |
| `tenants/{t}/projects/**`                                                                                               | `admin`, `am`, `production`, `production_manager` in-tenant, plus `super_admin` cross-tenant | denied                                        | denied    |
| `tenants/{t}/client-files/**`                                                                                           | `client` in-tenant **only** — `super_admin` is denied, in or out of the tenant               | denied                                        | denied    |
| `tenants/{t}/employees/**`                                                                                              | `admin` in-tenant, plus `super_admin` cross-tenant                                           | denied                                        | denied    |
| `tenants/{t}/employee-documents/**`                                                                                     | `hr`, `admin` in-tenant, plus `super_admin` cross-tenant                                     | denied                                        | denied    |
