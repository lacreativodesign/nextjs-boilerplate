...
module.exports = {
  create_invoice: makeAction('create_invoice', 'Create Invoice', [
    { key: 'clientId', required: true },
    { key: 'clientName', required: true },
    { key: 'amountTotal', required: true },
  ]),
  create_client: makeAction('create_client', 'Create Client', [
    { key: 'companyName', required: true },
    { key: 'primaryContactEmail', required: true },
  ]),
  create_task: makeAction('create_task', 'Create Task', [
    { key: 'projectId', required: true },
    { key: 'title', required: true },
  ]),
  create_project: makeAction('create_project', 'Create Project', [
    { key: 'projectName', required: true },
    { key: 'clientId', required: true },
  ]),
  update_invoice_status: makeAction('update_invoice_status', 'Update Invoice Status', [
    { key: 'invoiceId', required: true },
    { key: 'status', required: true },
  ]),
  send_notification: makeAction('send_notification', 'Send Notification', [
    { key: 'title', required: true },
