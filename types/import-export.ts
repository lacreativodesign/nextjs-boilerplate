export type ImportEntity = "clients" | "invoices" | "products" | "employees" | "projects" | "tasks" | "time_entries";

export type ImportJobStatus = "uploaded" | "validating" | "validated" | "processing" | "completed" | "failed" | "rolled_back";
